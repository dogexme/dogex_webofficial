...
export default defineComponent({
  ...
  setup(props) {
    ...
    return () => <DogTable defaultPageSize={500} rowkey="id" loading={loading.value} dataSource={dataSource.value} columns={columns.value} total={total.value} currentPage={page.value} onCurrent-change={query} onRefresh={() => query(page.value)}/>
  },
})
